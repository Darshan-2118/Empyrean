    ...
    <motion.div onClick={handleClick} className="step-indicator" style={disableStepIndicators ? { pointerEvents: 'none', opacity: 0.5 } : {}} animate={status} initial={false}>
      <motion.div
        variants={{
          ...
          active: { scale: 1, backgroundColor: 'rgba(255,255,255,0.2)', color: '#fff' },
          complete: { scale: 1, backgroundColor: 'rgba(255,255,255,0.2)', color: '#fff' }
        }}
...
function StepConnector({ isComplete }: any) {
  const lineVariants = {
    ...
    complete: { width: '100%', backgroundColor: 'rgba(255,255,255,0.2)' }
  };
